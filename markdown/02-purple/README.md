...
This folder contains the modular sections for the PURPLE stage of the APTITUDE course.
...
- [The Vibe Wavelength of Purple: Internalize (Feel)](./05-the-vibe-wavelength-of-purple-internalize-feel.md)
...
- [“INTERNALIZE (Feel)”](./13-internalize-feel.md)
...
Original monolithic file: `../2.PURPLE.md` (preserved as backup)
